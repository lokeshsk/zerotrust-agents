...
* **Community Edition (Source-Available - BSL 1.1)**: Includes the core firewall proxy, semantic DLP, basic HITL flows, multi-tenant workspaces, and master key authentication. *Free for all use-cases except offering a managed gateway service.* Converts to Apache 2.0 after 4 years.
