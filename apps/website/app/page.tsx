      ...
      <nav className="border-b border-white/10 bg-black/50 backdrop-blur-md fixed w-full top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-slate-300">
            ...
            <a href="https://github.com/lokeshsk/zerotrust-agents" target="_blank" rel="noreferrer" className="flex items-center space-x-2 bg-[#24292e] hover:bg-[#2f363d] border border-white/10 px-3 py-1.5 rounded-md transition-colors shadow-sm">
              ...
              <span className="text-sm font-semibold text-white">Star us</span>
              <span className="flex items-center space-x-1 bg-white/10 px-2 py-0.5 rounded-full text-xs font-semibold text-slate-200">
                <svg className="w-3 h-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span>{stars > 0 ? stars : 'Star'}</span>
              </span>
            </a>
          </div>
          <div>
