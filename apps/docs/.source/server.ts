...
import * as __fd_glob_9 from "../content/docs/templates.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"api.mdx": __fd_glob_0, "architecture.mdx": __fd_glob_1, "cli.mdx": __fd_glob_2, "enterprise.mdx": __fd_glob_3, "index.mdx": __fd_glob_4, "mcp.mdx": __fd_glob_5, "policy.mdx": __fd_glob_6, "proxies.mdx": __fd_glob_7, "quickstart.mdx": __fd_glob_8, "templates.mdx": __fd_glob_9, });
